import{_ as i}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as n,c as e,d as s}from"./app.b553a681.js";const d={},l=s(`<h1 id="ac\u81EA\u52A8\u673A" tabindex="-1"><a class="header-anchor" href="#ac\u81EA\u52A8\u673A" aria-hidden="true">#</a> AC\u81EA\u52A8\u673A</h1><div class="language-c++ ext-c++ line-numbers-mode"><pre class="language-c++"><code>//\u7EDF\u8BA1\u539F\u4E32\u4E2D\u6709\u591A\u5C11\u4E2A\u4E0D\u540C\u7684\u6A21\u5F0F\u4E32
const int N=2e6+5;
string s;
int tr[N][26],cnt=0;
int vi[N],fail[N];
